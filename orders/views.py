...
class OrderListView(ListView):
    """
    Представление для отображения списка заказов с фильтрацией по номеру стола и статусу.
    """
    model = Order
    ...
    def get_queryset(self):
        """
         Возвращает QuerySet заказов, отфильтрованных по GET-параметрам table_number и status.
         """
    ...
    def get_context_data(self, **kwargs):
        """
        Добавляет в контекст доступные статусы и текущие значения фильтров для шаблона.
        """
...
class OrderEditView(UpdateView):
    """
    Представление для полного редактирования заказа (номер стола, блюда, статус).
...
class RevenueView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        """
        Добавляет в контекст общую выручку и список оплаченных заказов.
        """
        ctx = super().get_context_data(**kwargs)
